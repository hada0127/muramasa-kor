...
1. [Releases](../../releases) 페이지에서 최신 `muramasa-kor-v0.6.1-vita3k-patcher.zip`을 받는다.
2. 같은 릴리즈의 `muramasa-kor-v0.6.1-vita3k-patcher-sha256.txt`로 zip 무결성을 검증한다.

```powershell
# Windows
Get-FileHash -Algorithm SHA256 .\muramasa-kor-v0.6.1-vita3k-patcher.zip
```

```bash
# macOS / Linux
shasum -a 256 muramasa-kor-v0.6.1-vita3k-patcher.zip
shasum -a 256 -c muramasa-kor-v0.6.1-vita3k-patcher-sha256.txt
```
...
- `muramasa-kor-v0.6.1-vita3k-patcher.zip`
- `muramasa-kor-v0.6.1-vita3k-patcher-manifest.json`
- `muramasa-kor-v0.6.1-vita3k-patcher-sha256.txt`
- `muramasa-kor-v0.6.1-vita3k-patcher-release-notes.txt`
