...
예를 들어 v0.8.2에서 처음 패치했다면 다음 파일이 생긴다.

```text
<Vita3K content root>/ux0/app/PCSE00240/.muramasa-kor-backup/NinPri.cpk.v0.8.2.original
<Vita3K content root>/ux0/app/PCSE00240/.muramasa-kor-backup/NinPriPatch.cpk.v0.8.2.original
```
...
1. [Releases](../../releases) 페이지에서 최신 `muramasa-kor-v0.8.2-vita3k-patcher.zip`을 받는다.
2. 같은 릴리즈의 `muramasa-kor-v0.8.2-vita3k-patcher-sha256.txt`로 zip 무결성을 검증한다.

```powershell
# Windows
Get-FileHash -Algorithm SHA256 .\muramasa-kor-v0.8.2-vita3k-patcher.zip
```

```bash
# macOS / Linux
shasum -a 256 muramasa-kor-v0.8.2-vita3k-patcher.zip
shasum -a 256 -c muramasa-kor-v0.8.2-vita3k-patcher-sha256.txt
```
...
- `muramasa-kor-v0.8.2-vita3k-patcher.zip`
- `muramasa-kor-v0.8.2-vita3k-patcher-manifest.json`
- `muramasa-kor-v0.8.2-vita3k-patcher-sha256.txt`
- `muramasa-kor-v0.8.2-vita3k-patcher-release-notes.txt`
