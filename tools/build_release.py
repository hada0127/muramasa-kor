...
def write_release_notes(notes_path: Path, version: str, zip_name: str) -> None:
    notes = (
        ...
        f"   and installs Vita3K texture imports. If the content root is `fs`, texture imports are\n"
        f"   copied to both `fs/textures/import/{TITLE_ID}/` and `textures/import/{TITLE_ID}/`.\n"
        f"\n"
