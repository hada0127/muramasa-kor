...
- [⏸] DLC 1 장비란 깨진 글자 (issue #2 항목 5) — 2026-05-16 분석 완료. NMS scename_US #116 "Miike-Okoi" → "삼색 오코이" 이미 패치됨 (v0.7.0부터). 사용자 v0.7.0 시점 NinPriPatch 적용 누락 추정. 최신 패치 적용 후 자동 해결 가능성 매우 높음 → 사용자 검증 대기
