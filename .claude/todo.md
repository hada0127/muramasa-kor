...
- [⏸] DLC 1 장비란 깨진 글자 (issue #2 항목 5) — 2026-05-16 deferred. NMS 모두 한글 패치 완료(검증 완료), CPK MD5 일치, 셰이더 캐시 클리어해도 여전히 깨짐. 영문 라벨이 Pack1 chara/Mike**.mbs (FMBS) 또는 eboot.bin hardcoded에서 옴 → NMS 패치 범위 밖. FMBS 역공학 필요 (위험·시간 큼). fail.md 참조
